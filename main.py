...
filename = input(
    "Please enter the location of acadmic calandar in csv format: ")
days = {
    "mon": "monday",
    "tues": "tuesday",
    "wed": "wednesday",
...
def main():
  ...
  rest_file = input(
      "Please provide the location of the file which contain details of 2nd yaer and rest(slot.csv) in csv format: "
  )
  ...
  # print(slot_data)
  # print(not_in_slot)
  if (error_flag == 0 and read_calender_error == 0
      and read_slot_data_error == 0 and rest_file_error == 0):
    ...
    mid_date = takingInput(
        "please provide the semester starting mid-sem-date :")
    holy_date = takingInput(
        "please provide the semester last mid_sem-holy-date:")
